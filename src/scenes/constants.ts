...
export const greetings = {
  ...
  anna_sk: {
    text: "С праздником весны, милая Аня! Пусть профессионализм и умение находить решения вдохновляют всех вокруг!",
  },
  natalia_v: {
  ...
  darya: {
    text: "Светлых эмоций, тепла и радости тебе, Даша! Пусть каждый день напоминает о твоей важности и ценности!",
  },
};
